...
class Controller: 
    ...
    def onFiducial(self, fiducialNum): 
        ...
        if isCustomer:
            ...
            print "ERROR: Fiducial number", fiducialNum, "belongs to neither",\
                  "item nor customer."                
...
class ServerData:
    ...
    database = structures.Database.fromXMLFile("database.xml")
    ...
    def do_GET(self):
        ...
        if "type" in parameters: 
            ...
            try:
                ...
                if path == "html/product_list.html":
