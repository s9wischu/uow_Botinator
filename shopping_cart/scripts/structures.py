...
class Item:
    ...
    def fromXML(node): 
        ...
        x = (float(node.find("locationX").text))
        y = (float(node.find("locationY").text))
    ...
    def getHTMLListString(self):
        ...
        root = html.parse("/home/motionlab/catkin_ws/src/shopping_cart/scripts/html/product_list_item.html").getroot()
